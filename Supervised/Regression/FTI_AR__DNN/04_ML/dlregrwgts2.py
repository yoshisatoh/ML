...
train_data_raw    = np.loadtxt('df_features_train_data_raw.csv', dtype='float64', delimiter=',', skiprows=1)

train_targets_raw = np.loadtxt('df_target_2_train_targets_raw.csv', dtype='float64', delimiter=',', skiprows=1)

test_data_raw     = np.loadtxt('df_features_test_data_raw.csv', dtype='float64', delimiter=',', skiprows=1)

test_targets_raw  = np.loadtxt('df_target_2_test_targets_raw.csv', dtype='float64', delimiter=',', skiprows=1)
...
np.savetxt('train_data2.csv', train_data, fmt ='%.8f', delimiter=',')
#
...
np.savetxt('train_targets2.csv', train_targets, fmt ='%.8f', delimiter=',')

test_data = sc.fit_transform(test_data_raw)
#test_data     = test_data_raw    # no standardization
np.savetxt('test_data2.csv', test_data, fmt ='%.8f', delimiter=',')

test_targets  = test_targets_raw
np.savetxt('test_targets2.csv', test_targets, fmt ='%.8f', delimiter=',')
...
model = Sequential([
    ...
    Dense(train_data.shape[1], activation='relu', name='L1_dense'),
    Dense(train_data.shape[1], activation='relu', name='L2_dense'),
    Dense(train_data.shape[1], activation='relu', name='L3_dense'),
    Dense(train_data.shape[1], activation='relu', name='L4_dense'),
    Dense(train_data.shape[1], activation='relu', name='L5_dense'),
    Dense(train_data.shape[1], activation='relu', name='L6_dense'),
    #Dense(train_data.shape[1], activation='relu', name='L7_dense'),
    #Dense(train_data.shape[1], activation='relu', name='L8_dense'),
    #Dense(train_data.shape[1], activation='relu', name='L9_dense'),
    #Dense(train_data.shape[1], activation='relu', name='L10_dense'),
    #
    ##### ********** Binary Classification **********
    #####Dense(1, activation='sigmoid', name='L1_dense')
    #
    ##### ********** Regression **********
    Dense(1, name='L7_dense')
    #####
])
...
[[-3.1396568e-02]
 ...
 [ 1.5450442e-01]]
'''
np.savetxt('test_targets_pred_raw2.csv', test_targets_pred_raw, fmt ='%.8f', delimiter=',')
...
np.savetxt('test_targets_pred2.csv', test_targets_pred, fmt ='%.8f', delimiter=',')
