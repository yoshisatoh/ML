...
train_targets_raw = np.loadtxt('df_target_1_train_targets_raw.csv', dtype='float64', delimiter=',', skiprows=1)

test_data_raw     = np.loadtxt('df_features_test_data_raw.csv', dtype='float64', delimiter=',', skiprows=1)

test_targets_raw  = np.loadtxt('df_target_1_test_targets_raw.csv', dtype='float64', delimiter=',', skiprows=1)
...
np.savetxt('train_data1.csv', train_data, fmt ='%.8f', delimiter=',')
#
...
np.savetxt('train_targets1.csv', train_targets, fmt ='%.8f', delimiter=',')

test_data = sc.fit_transform(test_data_raw)
#test_data     = test_data_raw    # no standardization
np.savetxt('test_data1.csv', test_data, fmt ='%.8f', delimiter=',')

test_targets  = test_targets_raw
np.savetxt('test_targets1.csv', test_targets, fmt ='%.8f', delimiter=',')
...
[[-3.1396568e-02]
 ...
 [ 1.5450442e-01]]
'''
np.savetxt('test_targets_pred_raw1.csv', test_targets_pred_raw, fmt ='%.8f', delimiter=',')
...
np.savetxt('test_targets_pred1.csv', test_targets_pred, fmt ='%.8f', delimiter=',')
