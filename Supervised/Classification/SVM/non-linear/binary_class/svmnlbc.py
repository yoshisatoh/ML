...
#
# Github:
# https://github.com/yoshisatoh/ML/tree/main/Supervised/Classification/SVM/non-linear/binary_class/svmnlbc.py
#
#
########## Input Data File(s)
#
...
#
#python svmnlbc.py df_yXz.csv y x0 x1 z 1E6
#
# Generally,
#python svmnlbc.py (df_name: data file with y, x0, x1, and z) (y_name: column y with a value 0 or 1) (x0_name: column x0) (x1_name: column x1) (z_name: column z)  (c_param: For very large c_param, the margin of is hard, and points cannot lie in it.)
#
