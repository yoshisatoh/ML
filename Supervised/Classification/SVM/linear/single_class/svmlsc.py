...
#
# Github:
# https://github.com/yoshisatoh/ML/tree/main/Supervised/Classification/SVM/linear/single_class/svmlsc.py
#
#
########## Input Data File(s)
#
...
#
#python svmlsc.py df_yX.csv y x0 x1 1E10
#
# Generally,
#python svmlsc.py (df_name: data file with y, x0, and x1) (y_name: column y) (x0_name: column x0) (x1_name: column x1) (c_param: For very large c_param, the margin of is hard, and points cannot lie in it.)
#
